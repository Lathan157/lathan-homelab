...
- **Node 4** – Ryzen 5 3600, RTX 3060, Frigate NVR, Obico AI  
...
- VLANs:  
  ...
  - VLAN 45 – IoT  
  - VLAN 70 – CCTV  
- Switching: Ubiquiti US-24, D-Link DGS-1210-48  
- Wi-Fi: UniFi 6+ AP  
...
More details: [docs/05-services.md](./docs/05-services.md)  

---

## Automation and Monitoring
- Home Assistant automations for presence, lighting, and server monitoring  
...
## Roadmap
- [ ] Consolidate and migrate ZFS pools under TrueNAS  
- [ ] Expand Kubernetes cluster using Wyse 3040 nodes  
- [ ] Build a public portfolio website hosted from the homelab   
- [ ] Implement offsite replication and backup solutions  
